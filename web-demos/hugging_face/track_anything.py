...
from inpainter.run_inference import StableDiffusionInpainting
...
class TrackingAnything():
    def __init__(self, sam_checkpoint, cutie_checkpoint, propainter_checkpoint, raft_checkpoint, flow_completion_checkpoint, args):
        ...
        self.baseinpainter = StableDiffusionInpainting("runwayml/stable-diffusion-inpainting", steps=20)
